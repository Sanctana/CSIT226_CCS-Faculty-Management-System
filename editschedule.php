...
<link rel="stylesheet" href="assets/css/editschedule.css">
                    ...
                    <form method="post">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" id="summaryCourse" value="<?php echo htmlspecialchars($schedule['coursecode'] . ' - ' . $schedule['coursetitle']); ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Faculty</label>
                                <input type="text" class="form-input" id="summaryFaculty" value="<?php echo htmlspecialchars($schedule['firstname'] . ' ' . $schedule['lastname']); ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" id="summarySection" value="<?php echo htmlspecialchars($schedule['section']); ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label class="form-label">School Year</label>
                                <input type="text" class="form-input" id="summarySchoolYear" value="<?php echo htmlspecialchars($schedule['schoolyear']); ?>" disabled>
                            </div>
                        </div>
...
<div class="confirm-overlay" id="confirmOverlay" aria-hidden="true">
    <div class="confirm-modal" role="dialog" aria-modal="true" aria-labelledby="confirmTitle">
        <div class="confirm-header" id="confirmTitle">Confirm Schedule Update</div>
